...
const BreadcrumbEllipsis = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => (
  <span
    ...
    {...props}
  >
    <span className="box-border inline-flex h-[0.3em] w-[0.3em] rounded-full bg-current transition-colors ease-in-out first:ml-1 last:mr-1">
      &nbsp;
    </span>
    <span className="mx-px box-border inline-flex h-[0.3em] w-[0.3em] rounded-full bg-current transition-colors ease-in-out first:ml-1 last:mr-1">
      &nbsp;
    </span>
    <span className="box-border inline-flex h-[0.3em] w-[0.3em] rounded-full bg-current transition-colors ease-in-out first:ml-1 last:mr-1">
      &nbsp;
